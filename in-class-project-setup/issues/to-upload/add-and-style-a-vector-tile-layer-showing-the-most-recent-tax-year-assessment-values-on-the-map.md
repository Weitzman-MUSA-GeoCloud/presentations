...
* The URL template for the tiles is `https://storage.googleapis.com/{{gcp_project}}-public/tiles/properties/{z}/{x}/{y}.pbf`, and the name of the layer with property information is `property_tile_info`.
