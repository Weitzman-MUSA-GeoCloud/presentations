...
You should base the inputs to your model on the tables in the `core` dataset in BigQuery. You will need to work with your teammates to ensure you understand what fields will be available in each of those tables.

The model can be implemented in BigQuery SQL, or in R/Python.
* See issue #10 for a few notes to keep in mind for your model
